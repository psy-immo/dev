...
mysql_query("CREATE TABLE IF NOT EXISTS `logs` (`id` text NOT NULL, `doc` text NOT NULL, `time` text NOT NULL, `log` text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='log files'") 
or debug_die("Create logs: ".mysql_error());

mysql_query("CREATE TABLE IF NOT EXISTS `storage` (`id` text NOT NULL, `doc` text NOT NULL, `name` text NOT NULL, `value` text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='log files'")
