...
public class SubjectNotWorkingTag extends StandardDeferrable implements AnyTag,
GlobalModifier {
	...
	public SubjectNotWorkingTag(BodyTag body) {
		this.body = body;
		this.token = "";
	}
	...
	public void DoAction() {
		this.body.setNotWorkingMessage(this.token);
