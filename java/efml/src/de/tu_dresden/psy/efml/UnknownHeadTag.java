/**
 * LinkTag.java, (c) 2013, Immanuel Albrecht; Dresden University of Technology,
...
/**
 * this class represents a link tag which will just be reproduced as it was in
 * the efml in the output html head section
 * 
 * @author immanuel
 * 
 */
public class UnknownHeadTag implements AnyTag {
	...
	public UnknownHeadTag(EfmlTagsAttribute reproduce) {
